<x-slide-over name="edit">
    <div class="mb-8 flex items-center justify-between">
        ...
        <button type="button" class="inline-flex text-gray-500">
    ...
    <div class="mb-5 flex items-center justify-between">
        <div class="text-xl font-medium text-gray-600">#AL2534</div>
    ...
    <form action="">
        <div class="mb-8">
            <label for="invoice_name" class="block mb-1 text-sm text-gray-600">Invoice Name (Project / Description)</label>
            <input type="text" value="{{ $invoice->name }}" class="block w-full py-2.5 px-3.5 rounded-lg text-sm text-gray-800 bg-gray-200/50 focus:bg-gray-200 focus:outline-none" required>
        </div>
        <div class="mb-11 grid grid-cols-2 gap-4">
            <div>
                <label for="issue_date" class="block mb-1 text-sm text-gray-600">Issue Date</label>
                <input type="date" class="block w-full py-2.5 px-3.5 rounded-lg text-sm text-gray-800 bg-gray-200/50 focus:bg-gray-200 focus:outline-none placeholder-gray-500">
            </div>
            <div>
                ...
                <tbody>
                    <tr>
                        <td class="pr-1.5 pt-2">
                            <input type="text" class="block w-full py-2.5 px-3.5 rounded-lg text-sm text-gray-800 bg-gray-200/50 focus:bg-gray-200 focus:outline-none placeholder-gray-500">
                        </td>
                        <td class="px-1.5 pt-2">
                            <input type="text" class="block max-w-[3rem] w-full py-2.5 px-3.5 rounded-lg text-sm text-gray-800 bg-gray-200/50 focus:bg-gray-200 focus:outline-none placeholder-gray-500">
                        </td>
                        <td class="px-1.5 pt-2">
                            <input type="text" class="block w-full max-w-[5rem] py-2.5 px-3.5 rounded-lg text-sm text-gray-800 bg-gray-200/50 focus:bg-gray-200 focus:outline-none placeholder-gray-500">
                        </td>
                        <td class="px-1.5 pt-2">
