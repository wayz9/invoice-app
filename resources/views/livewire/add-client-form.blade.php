<x-modal name="addClientModal" class="!max-w-4xl">
    <form wire:submit.prevent="create" class="py-5 px-6">
        <div class="mb-8 flex items-center justify-between">
            <div>
                <h2 class="text-lg font-semibold text-gray-800">Add New Client</h2>
                <p class="text-sm text-gray-600">Add a new client to start sending them invoices.</p>
            </div>
            <button type="button" @click="addClientModal = false" class="focus:outline-none text-gray-600">
