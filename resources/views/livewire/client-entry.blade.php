<div x-data="{open : false, deleteModal : @entangle('deleteModal'), editModal : @entangle('editModal')}">
    <div
            ...
            <div x-data="{show : false}" class="relative inline-block">
                ...
                <div x-cloak class="absolute mt-1 w-44 origin-top-right right-0 bg-white z-40 rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
                    ...
                    <div class="py-1" role="none">
                        ...
                        <button type="button" @click="editModal = true" class="text-gray-700 w-full hover:bg-gray-100 hover:text-gray-900 flex items-center px-4 py-2 text-sm"
                            role="menuitem" tabindex="-1">Edit Client</button>
