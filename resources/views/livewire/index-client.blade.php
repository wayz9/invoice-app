<div x-data="{addClientModal : @entangle('addClientModal')}">
    <div class="mb-12 grid md:grid-cols-3 xl:grid-cols-4 gap-6">
        <div class="py-3.5 px-4 space-y-1.5 rounded-lg bg-white ring-1 ring-inset ring-zinc-50">
            <div class="text-sm font-medium text-zinc-600">Total Received</div>
            <div class="flex items-center gap-2.5">
                <span class="text-2xl font-bold text-zinc-900">$18,950.00</span>
                <div class="pl-1 flex items-center bg-lime-50 rounded">
                    <span class="text-xs font-semibold leading-5 text-lime-600">
                        24K
                    </span>
                    <span class="inline-flex text-lime-600 transform rotate-[-135deg]">
            ...
            <div class="text-sm font-medium text-zinc-500">Total Income</div>
        </div>
        <div class="py-3.5 px-4 space-y-1.5 rounded-lg bg-white ring-1 ring-inset ring-zinc-50">
            <div class="text-sm font-medium text-zinc-600">Clients</div>
            <div class="flex items-center gap-2.5">
                <span class="text-2xl font-bold text-zinc-900">26</span>
                <div class="pl-1 flex items-center bg-lime-50 rounded">
                    <span class="text-xs font-semibold leading-5 text-lime-600">
                        15
                    </span>
            ...
            <div class="text-sm font-medium text-zinc-500">Your Clients</div>
        </div>
        <div class="py-3.5 px-4 space-y-1.5 rounded-lg bg-white ring-1 ring-inset ring-zinc-50">
            <div class="text-sm font-medium text-zinc-600">Invoices</div>
            <div class="flex items-center gap-2.5">
                <span class="text-2xl font-bold text-zinc-900">451</span>
                <div class="pl-1 flex items-center bg-red-50 rounded">
                    <span class="text-xs font-semibold leading-5 text-red-600">
                        12
                    </span>
                    <span class="inline-flex text-red-600 transform -rotate-45">
                        <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
                            <path fill-rule="evenodd"
                                d="M8 4a.5.5 0 0 1 .5.5v5.793l2.146-2.147a.5.5 0 0 1 .708.708l-3 3a.5.5 0 0 1-.708 0l-3-3a.5.5 0 1 1 .708-.708L7.5 10.293V4.5A.5.5 0 0 1 8 4z" />
                        </svg>
            ...
            <div class="text-sm font-medium text-zinc-500">Invoices Created</div>
        </div>
    </div>
    <section>
        <div class="mb-6 flex items-center justify-between">
            <div>
                <h2 class="text-lg font-semibold text-zinc-900">Clients</h2>
                <div class="text-sm font-medium text-zinc-600">List of all of your clients </div>
            </div>
            <button x-on:click="addClientModal = true" type="button"
                ...
                <span class="text-sm font-semibold text-lime-100">Add Client</span>
            </button>
        </div>
    ...
    <ul class="mb-8 grid gap-y-6">
        ...
        <div class="py-24 flex flex-col items-center justify-center text-center">
            ...
            <p class="text-sm font-medium text-zinc-600">To add a client click on<br><span
                    class="font-semibold text-zinc-900">Add Client</span> button above
            </p>
        </div>
        @endforelse
    </ul>
