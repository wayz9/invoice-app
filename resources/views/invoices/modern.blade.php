...
<body style="background: white">
    <div style="width: 100%; margin-bottom: 36px;">
        <div class="inline-block" style="width: 49%;">
            ...
            <div class="paragraph">202-555-0826</div>
        </div>
        <div class="inline-block" style="width: 50%;">
            <div class="paragraphtop">{{ auth()->user()->name }}</div>
            <div class="paragraphtop">{{ auth()->user()->email }}</div>
            <div class="paragraphtop">#{{ $invoice->invoice_number }}</div>
        </div>
    </div>
    <div>
        <div
            style="background-image: url(https://cdn.dribbble.com/users/3742223/screenshots/7194529/media/545db453b7ccdbb343dd8500acad83b8.jpg); height: 200px; border-radius: 16px; background-position: center; background-size: cover; width: 100%;">
        </div>
    </div>
    <div style="width: 100%; margin-top: 40px; margin-bottom: 32px;">
        ...
        <div class="inline-block" style="width: 29%; text-align: right; vertical-align:top">
            <div>
                ...
                <div style="font-weight: 600; color: #18181b; font-size: 28px; line-height: 36px;">
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="py-6 text-right pr-8">${{ to_money($item->converted_price) }}</td>
                <td class="py-6 pl-8">{{ $item->qty }}</td>
                <td class="py-6 text-right">${{ to_money($item->total) }}</td>
            </tr>
            @endforeach
        </tbody>
    </table>
    ...
    <div style="width: 100%; margin-top: 32px;">
        ...
        <div class="inline-block" style="width: 24%">
            <div class="text-right" style="font-weight: 700; color: #18181b">
                ${{ to_money($invoice->subtotal()) }}
            </div>
        </div>
    </div>
